...
class pageThird(QWidget):
    def __init__(self):
        super(pageThird, self).__init__() ## Call the inherited classes __init__ method
        self.mainData = MainData.instance()
        uic.loadUi(os.path.join(self.mainData.dir.GUI_DIR, "pageThird.ui"), self)
